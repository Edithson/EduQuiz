...
class Classe
{
    ...
    {
        $classe = $this->cnx->prepare('SELECT classe.id, id_cycle, id_specialite, classe.intitule FROM classe, filiere WHERE classe.id_specialite=filiere.id AND filiere.id=?');
